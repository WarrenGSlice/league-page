<script>
    ...
    let two, twoOne, twoOneOne, twoOneTwo, twoTwo, twoThree;
    let three, threeOne;
...
<div class="constitution">
    <h1 class="noUnderscore">LEAGUE OF CHAMPIONS CONSTITUTION</h1>
    ...
    <p>3 IR Spots (Player must be labeled as IR, OUT, COVID, SUS, NA, DNR, HOLDOUT, OPT-OUT, or Doubtful in the Sleeper App)</p>
        ...
        <div class="subBlock">
            <table class="positionMaximums">
                <tr><td>QB</td><td class="right">no limits</td></tr>
                <tr><td>RB</td><td class="right">no limits</td></tr>
                <tr><td>WR</td><td class="right">no limits</td></tr>
                <tr><td>TE</td><td class="right">no limits</td></tr>
            </table>
        </div>
    ...
    <p>Trading of future draft picks outside of the current league year can be denied at the dicression of the commish if the commish questions the reliability of a manager. If a manager has no intention of playing the following year. Draft pick trades can be vetoed or repealed.</p>
    ...
    <div class="subBlock">
        ...
        <p>Veto power only exists for the commish, but the commish as a rule will veto no trades unless there is an extreme circumstance. We are all adults and have the capacity to evaluate what is best for our respective teams.</p>

        <p>The commissioner will err on the side of letting owners manage their teams the way they see fit. Any collusion will need to be clear. The commissioner reserves the right to step in and at the very least ask both owners of a trade if they really meant to do a heavily lop-sided trade. If one owner says it was an accident, the trade shall be reversed. </p>
    </div>
    ...
    <div class="subBlock">
        <p>The trade deadline will be set for the Monday 12:00am of the week 9 last weekly game of week 9.</p>
    </div>
    ...
    <div class="subBlock">
        <p>This is a league for adults and veto's are not and will never be a thing. If we feel like veto's need to exist, its probably time to end the league.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100. $0 bids are allowed. Bids will process Thursdays and Sundays at 9AM EST. Waiver priority will decide ties.</p>

    <p>FAAB budgets will reset and the end of each new league years' rookie draft.</p>
    ...
    <h3 bind:this={twoOneOne}>2.1.1 Draft Order for Non-Playoff Teams</h3>
    ...
    <p>If a trade is being made during the draft, one or both parties can make the trade immediately, enjoy.</p>
    
    <h2 class="sectionHeading" bind:this={three}>Section 3 Scoring System</h2>

    <h3 bind:this={threeOne}>3.1 Scoring System</h3>
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows typical 1.0PPR Scoring). The scoring system will never change without a majority league vote. (Minor adjustment may be changed at the commish's dicression, with or without announcement to the league.)</p>
    
    <h2 class="sectionHeading" bind:this={four}>Section 4 Postseason</h2>
    
    <h3 bind:this={fourOne}>4.1 Playoffs</h3>
    <p>At the end of the season, 6 teams will make the playoffs. The first round of playoffs will commence in week 15. The top 6 teams with the best records, will receive a playoff berth. The 2 teams with the best records will receive a bye week in the first round of the playoffs. Each playoff matchup will only last one week and the winner will advance. There will be re-seeding. Week 18 will not be used.</p>
    ...
    <p>No team may intentionally leave starting roster spots empty. Any evidence of intentionally leaving roster spots empty will result in the commish telling the manager to fix it and if not fixed, the commish will put in a player for them. Managers may play players of any status (IR, OUT, NA, D, DNR, ect). It doesn't matter as long as a player is played.</p>
    <p>In addition to these policies, 2024 marks the first year best ball points for will be used for draft-pick positioning with the intent of preventing strong teams from tanking to get the top picks. The only way for good teams to aquire top picks are to trade for them.</p>

    <h2 class="sectionHeading" bind:this={six}>Section 6 Replacing Managers</h2>
    
    <h3 bind:this={sixOne}>6.1 Removing Managers</h3>
    <p>Short of continuously confirmed collusion, no manager can be removed against their will while being paid up on dues. Participation, through the league chat, trade offers, and the waiver wire, is strongly encouraged but generally grounds for removal. If a manager does not pay their dues by the start of the rookie draft, they will be removed and replaced.</p>
    ...
    <p>In the event that a manager chooses to quit the league or is removed by a comissioner and has a very bad roster, an incoming manager is offered a 50% reductioon on their first year buy-in. If the team being taken over has a strong roster, no price reduction will be offered. The difference will be covered by the commish. What a nice guy huh.</p>
    ...
    <p>A ⅔ majority vote is required in order to raise league dues and must be approved by the commish with the consideration that all managers could actually afford an increase. In the event that a manager is no longer financially comfortable with the buyin, finding a co-manager to split the cost is reccomended.</p>
